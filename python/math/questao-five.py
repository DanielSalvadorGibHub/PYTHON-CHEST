...
while resultado == False:
    ...
    if media >= 7:
        final = "Aprovado"
        print(f"A sua média nesse trimestre foi {media:.1f} logo você foi {final}!")
        resultado = True
    #AQUI ESTÁ A CONDICIONAL SE O ALUNO ESTÁ EM RECUPERAÇÃO!
    elif media == 6:
        final = "RECUPERAÇÃO"
        print(f"a sua média nesse trimestre foi {media:.1f} logo você está em {final}!")
        resultado = True
...
print(f"Média geral do curso: {media:.1f} ")
